...
<body>
    <div class="login-page">
        <div class="form">
            ...
            <br>
            <form class="login-form" method="post" action="<?php echo site_url('Register/register'); ?>">
                ...
                <input type="text" name="full_name" placeholder="nama lengkap" id="full_name" required />
